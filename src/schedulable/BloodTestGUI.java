...
public class BloodTestGUI extends javax.swing.JFrame {
    ...
    private NoShowList noShowList = new NoShowList();
    ...
    private void initComponents() {
        ...
        nameLBL.setBounds(30, 30, 30, 16);

        ageLBL.setText("age");
        getContentPane().add(ageLBL);
        ageLBL.setBounds(40, 70, 19, 16);

        priorityLBL.setText("priority");
        getContentPane().add(priorityLBL);
        priorityLBL.setBounds(30, 110, 38, 16);

        gpLBL.setText("GP details");
        getContentPane().add(gpLBL);
        gpLBL.setBounds(20, 150, 52, 16);

        noShowLBL.setText("no shows");
        getContentPane().add(noShowLBL);
        noShowLBL.setBounds(390, 20, 50, 16);
        ...
        hospitalCKB.setBounds(370, 290, 103, 20);
        ...
        jScrollPane2.setBounds(240, 20, 210, 100);

        jLabel2.setText("no shows");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(390, 70, 50, 16);
    ...
    private void addBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBTNActionPerformed
        ...
        int age = Integer.parseInt(ageTXT.getText()); // May throw exception
    ...
    private void updateDisplay() {
        displayTXT.setText(scheduler.getQueueDetails());
    }
    /**
